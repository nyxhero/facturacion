...
class Persona {
    ...
    public function listarDataTable($postData) {
        ...
        $aColumns = array('id', 'dni', 'nombres', 'paterno', 'materno', 'sexo' );
        $sIndexColumn = 'id';
        $sTable = 'persona';
...
//            $output['data'][] = $row;
    ...
    public function insertar($data) {
        ...
        $this->_misql->sql = "INSERT INTO persona SET dni='". $data["dni"] ."', nombres='". $data["nombres"] ."', paterno='". $data["paterno"] ."', materno='". $data["materno"] ."', sexo='". $data["sexo"] ."' ";
    ...
    public function actualizar($data) {
        $this->_misql->conectar();
        $this->_misql->sql = "UPDATE persona SET dni='". $data["dni"] ."', nombres='". $data["nombres"] ."', paterno='". $data["paterno"] ."', materno='". $data["materno"] ."', sexo='". $data["sexo"] ."' ";
    ...
    public function eliminar($id) {
        $this->_misql->conectar();
        $this->_misql->sql = "DELETE FROM PERSONA WHERE id=$id";
